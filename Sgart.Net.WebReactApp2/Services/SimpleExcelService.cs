...
namespace Sgart.Net.WebReactApp2.Services
{
    ...
    public class SimpleExcelService : IDisposable
    {
        ...
        private void Init()
        {
            if (_package == null)
            {
                throw new ArgumentNullException("Package as null");
            }
        ...
        public void AddSheet(string sheetName)
        {
            if (_package == null)
            {
                throw new ArgumentNullException("_package as null");
            }

            var workbookPart = _package.WorkbookPart;
            if (workbookPart == null)
            {
                throw new ArgumentNullException("workbookPart as null");
            }
            ...
            if (sheets == null)
            {
                throw new ArgumentNullException("Sheets as null");
            }
            ...
            if (sheets.Elements<Sheet>().Any())
            {
                sheetId = sheets.Elements<Sheet>()
                    .Select(s => s.SheetId.HasValue ? s.SheetId.Value : 0)
                    .Max() + 1;
            }
        ...
        public void AddRow()
        {
            if (_sheetData == null)
            {
                throw new ArgumentNullException("_sheetData as null");
            }
        ...
        private string AddrowInternal(Cell cell)
        {
            if (_row == null)
            {
                throw new ArgumentNullException("_row as null");
            }
